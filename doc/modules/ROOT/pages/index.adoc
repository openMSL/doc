...
The co-simulation ecosystem is compiled of various standards and tools containing different acronyms and abbreviations.
You can find a xref:abbreviations.adoc[list of widely used abbreviations] in this documentation.
